import Client from 'unnamed-network/client.js';
import { randomStr, EventDispatcher } from 'unnamed-network/utils.js';
...
function App(connManager, { defaultFirstAddr, document, localStorage }) {
  ...
  if (document) {
    ...
    function updateMyNameDom() {
      document.title = `[${myName}] Chatroom with youtube sync`;
